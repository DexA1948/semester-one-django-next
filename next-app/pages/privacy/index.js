...
export default function Privacy() {
	return (
		<div className="index">
			<Head>
				<title>Privacy Policy | SemesterOne</title>
				<meta name="description" content="Privacy Policy" />
				<meta data-rh="true" property="og:title" content="Privacy Policy" />
				<meta
					data-rh="true"
					property="og:description"
					content="Privacy Policy - SemesterOne"
				/>
				<link
					rel="canonical"
					...
					<div className="terms-sec mt-5">
						...
						<div className="row mt-5">
							...
							<div className="col-lg-8 about">
								...
								<p>
									At SemesterOne, accessible from https://semesterone.com, one
									of our main priorities is the privacy of our visitors. This
									Privacy Policy document contains types of information that is
									collected and recorded by SemesterOne and how we use it.
								</p>
								<p>
								...
								<p>
									...
									information that they shared and/or collect in SemesterOne.
									...
									Generator and the Free Privacy Policy Generator.
								</p>
								<h3>Consent</h3>
								<p>
								...
								<h3>Log Files</h3>
								<p>
									SemesterOne follows a standard procedure of using log files.
								...
								<p>
									Like any other website, SemesterOne uses 'cookies'. These
								...
								<p>
									...
									of the advertising partners of SemesterOne.
								</p>
								<p>
									Third-party ad servers or ad networks uses technologies like
									cookies, JavaScript, or Web Beacons that are used in their
									respective advertisements and links that appear on
									SemesterOne, which are sent directly to users' browser. They
								...
								<p>
									Note that SemesterOne has no access to or control over these
									cookies that are used by third-party advertisers.
								</p>
								<h3>Third Party Privacy Policies</h3>
								<p>
									SemesterOne's Privacy Policy does not apply to other
								...
								<p>
									SemesterOne does not knowingly collect any Personal
