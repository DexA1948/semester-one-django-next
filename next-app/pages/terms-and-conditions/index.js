...
export default function TermsAndConditions() {
	return (
		<div className="index">
			<Head>
				<title>Terms & Conditions | SemesterOne</title>
				<meta name="description" content="Terms & Conditions" />
				<meta data-rh="true" property="og:title" content="Terms & Conditions" />
				<meta
					data-rh="true"
					property="og:description"
					content="Terms & Conditions - SemesterOne"
				/>
				<link
					rel="canonical"
					href={`${process.env.NEXT_PUBLIC_DOMAIN_URL}/terms-and-conditions`}
				></link>
			</Head>
			<Header />
			<Container>
				<main className="home">
					<div className="terms-sec mt-5">
						...
						<div className="row mt-5">
							...
							<div className="col-lg-8 about">
								...
								<p>Welcome to SemesterOne!</p>
								<p>
									These terms and conditions outline the rules and regulations
									for the use of SemesterOne's Website, located at{" "}
									<a title="SemesterOne" href="/">
										https://semesterone.com
									</a>
									.
								</p>
								<p>
									By accessing this website we assume you accept these terms and
									conditions. Do not continue to use SemesterOne if you do not
								...
								<h3>Cookies</h3>
								<p>
									We employ the use of cookies. By accessing SemesterOne, you
									agreed to use cookies in agreement with the SemesterOne's
									Privacy Policy.
								</p>
								<p>
								...
								<h3>License</h3>
								<p>
									Unless otherwise stated, SemesterOne and/or its licensors own
									the intellectual property rights for all material on
									SemesterOne. All intellectual property rights are reserved.
									You may access this from SemesterOne for your own personal use
									subjected to restrictions set in these terms and conditions.
								</p>
								<p>You must not:</p>
								<ul>
									<li>Republish material from SemesterOne</li>
									<li>Sell, rent or sub-license material from SemesterOne</li>
									<li>
										Reproduce, duplicate or copy material from SemesterOne
									</li>
									<li>Redistribute content from SemesterOne</li>
								</ul>
								<p>
									...
									website. SemesterOne does not filter, edit, publish or review
									Comments prior to their presence on the website. Comments do
									not reflect the views and opinions of SemesterOne,its agents
									and/or affiliates. Comments reflect the views and opinions of
									the person who post their views and opinions. To the extent
									permitted by applicable laws, SemesterOne shall not be liable
								...
								<p>
									SemesterOne reserves the right to monitor all Comments and to
								...
								<p>
									You hereby grant SemesterOne a non-exclusive license to use,
								...
								<p>
									...
									compensates the absence of SemesterOne; and (d) the link is in
								...
								<p>
									...
									inform us by sending an e-mail to SemesterOne. Please include
								...
								<p>
									No use of SemesterOne's logo or other artwork will be allowed
								...
								<p>
									Please read{" "}
									<a title="SemesterOne - Privacy Policy" href="/privacy/">
										Privacy Policy
									</a>
								</p>
